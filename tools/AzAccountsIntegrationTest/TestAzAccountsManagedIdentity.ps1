...
Write-Output "----------------- Update $ModulePath to $ModuleVersion -------------------------"
Set-AzAutomationModule -AutomationAccountName $automationAccount -Name 'Az.Accounts' -ContentLinkUri $ModulePath -ContentLinkVersion $ModuleVersion -ResourceGroupName $resourceGroupName -RuntimeVersion "7.2"
