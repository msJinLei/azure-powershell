...
Write-Host 'Create Runbook of PowerShell-7.2'
$RunbookName = 'AzAccountsTestRunbook'
Import-AzAutomationRunbook -Path 'AzAccountsTestRunbook.ps1'  -Name $RunbookName -Type 'PowerShell72' -AutomationAccountName $AutomationAccount -ResourceGroupName $ResourceGroupName -Force -Debug
