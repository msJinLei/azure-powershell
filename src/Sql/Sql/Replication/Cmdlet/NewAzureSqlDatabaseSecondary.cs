    ...
    public class NewAzureSqlDatabaseSecondary : AzureSqlDatabaseSecondaryCmdletBase
    {
        ...
        protected override IEnumerable<AzureReplicationLinkModel> GetEntity()
        {
            ...
            throw new PSArgumentException(
                string.Format(Properties.Resources.DatabaseNameExists, GetEffectivePartnerDatabaseName(this.DatabaseName, this.PartnerDatabaseName), this.PartnerServerName),
                "DatabaseName");
        }
